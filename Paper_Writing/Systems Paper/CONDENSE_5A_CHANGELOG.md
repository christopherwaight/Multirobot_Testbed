...
| Sec. V/VI prose + 5 figure trims + Tables II/IV one-row-per-field + 3 figs to columnwidth | Final pass reached 11 pages; compiles clean, 0 undefined refs | Target met, stopped cutting | ~0.85 page total |
