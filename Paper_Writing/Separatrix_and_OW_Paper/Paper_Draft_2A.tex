...
chance. The closed loop is expected to fail at a somewhat higher level,
since saturation bounds the damage of an individual bad command and the
noise is redrawn at every cycle; the Monte Carlo sweep that follows
