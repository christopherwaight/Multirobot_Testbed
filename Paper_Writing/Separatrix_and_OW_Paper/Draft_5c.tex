...
\textit{Minimality:}\label{prop:minimality} each robot contributes one equation per component to
...
center. The resulting pentagon-plus-center shape,\label{cor:pentagon} five robots on a ring
...
switch to chatter. Along the trench, $\tau \geq 0$ in both branches of
...
saddle their initial tangent orientation resolves toward: two end
within 0.02 of $\mathbf{p}^*_2 = (0, 0.5)$, four at $\mathbf{p}^*_1 = (0, -0.5)$. The mean
...
case checked before the FLOW test in (\ref{eq:d_law}),
\begin{equation}
    \dot{\mathbf{p}}_c =
