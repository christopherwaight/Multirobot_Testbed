...
Alternately, the technique is using a structural prior, such as imposing
$\operatorname{tr}(\mathbf{J}) = 0$. We do not impose any priors on the
field, as horizontal surface currents are not divergence free, so imposing
