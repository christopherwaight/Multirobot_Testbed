...
the gain choice that never binds at the realized speeds
(under 1~m/s). The double-gyre
...
what the record reports; its realized speed stays within
...
is set earlier, by the reliability of its one-time flow-seeded tangent
sign.
