...
The attraction and orbital primitives were validated separately in this
work. Sequencing them into a single approach-then-orbit operation,
including the switching logic between the two control laws, remains to
be demonstrated.
