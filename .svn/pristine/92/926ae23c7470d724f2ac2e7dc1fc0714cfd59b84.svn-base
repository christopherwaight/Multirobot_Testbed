function [Vf] = SwarmSimWeightedCWOrbitNew(RobotParams, NRobot, SensorRange,WeightFunction,SysParam)
%SwarmSimWeightedCWOrbitNew Weighted Orbit behavior for Swarm_Adaptive_Navigation_Simulator.slx
...
W = WeightFunction(NRobot,RobotParams,SensorRange,SysParam);
