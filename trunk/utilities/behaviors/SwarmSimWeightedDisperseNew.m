function [Vf] = SwarmSimWeightedDisperseNew(RobotParams, NRobot, SensorRange,WeightFunction,SysParam)
%SwarmSimWeightedDisperseNew Weighted disperse behavior for Swarm_Adaptive_Navigation_Simulator.slx
