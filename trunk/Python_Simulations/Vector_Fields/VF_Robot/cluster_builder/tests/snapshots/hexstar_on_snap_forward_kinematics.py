"""Forward kinematics for hexstar_on_snap hub-and-spoke (6 robots).
State vars: ['x_h', 'y_h', 'theta_c', 'r_1', 'r_2', 'r_3', 'r_4', 'r_5', 'gamma_2', 'gamma_3', 'gamma_4', 'gamma_5', 'phi_1', 'phi_2', 'phi_3', 'phi_4', 'phi_5', 'phi_6']
"""
import math
