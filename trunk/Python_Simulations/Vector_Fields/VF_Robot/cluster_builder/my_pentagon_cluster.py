"""
MyPentagonCluster — generated by clusterbuilder.py
...
from my_pentagon_forward_kinematics import forward_kinematics
from my_pentagon_inverse_kinematics import inverse_kinematics
from my_pentagon_inverse_jacobian import inverse_jacobian, STATE_VARS


class MyPentagonCluster:
    ...
    def __repr__(self):
        c = self.get_centroid()
        return f"MyPentagonCluster(centroid={c}, N=6)"
