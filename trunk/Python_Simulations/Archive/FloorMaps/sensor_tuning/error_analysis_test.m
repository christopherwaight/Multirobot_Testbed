...
rmse_before1 = sqrt(mean((Ytesttrue(:,1) - X(:,5)).^2))
rmse_before2 = sqrt(mean((Ytesttrue(:,2) - sat_before).^2)) 


rmse_after1 = sqrt(mean((Ytesttrue(:,1) - X(:,5)).^2))
rmse_after2 = sqrt(mean((Ytesttrue(:,2) - X(:,6)).^2)) 
