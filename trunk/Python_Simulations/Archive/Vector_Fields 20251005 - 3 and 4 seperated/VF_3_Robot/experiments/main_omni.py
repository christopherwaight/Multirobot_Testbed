...
def run_single_simulation():
    ...
    print("=" * 60)
    print("OMNI CLUSTER SIMULATION - SINGLE ENVIRONMENT")
    print("=" * 60)
...
def run_comparison_simulation():
    ...
    print("=" * 60)
    print("OMNI CLUSTER SIMULATION - MODE COMPARISON")
    print("=" * 60)
...
def run_multi_environment_simulation():
    ...
    print("=" * 60)
    print("OMNI CLUSTER SIMULATION - 18 ENVIRONMENTS")
    print("=" * 60)
    ...
    fig.suptitle(f'Omni Cluster Simulations - All 18 Environments ({mode_str})', fontsize=16)

    # Get control primitive
    control_func = get_control_primitive()

    # Loop through all 18 environments
    for i, (env_func, env_name, env_key) in enumerate(all_environments, 1):
        ...
        # Run simulation
        execute_omni_simulation(cluster, control_func, env_name, ax=ax)
