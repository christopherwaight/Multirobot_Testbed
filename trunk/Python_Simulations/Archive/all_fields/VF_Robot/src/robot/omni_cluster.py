...
class OmniCluster:
    ...
    def sample_scalar_field_at_robots(self):
        ...
        Returns:
            List of z values (scalars) for each robot
        """
    ...
    def estimate_gradient(self):
        ...
        z1 = self.robots[0].sample_scalar_field(self.field)
        z2 = self.robots[1].sample_scalar_field(self.field)
        z3 = self.robots[2].sample_scalar_field(self.field)
