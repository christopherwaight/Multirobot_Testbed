...
% Assign Input Variables and Target Values (expected outputs)
rows_to_include = 20;
...
%% Normalize data  and adding Features(0 to 1)
...
numAugmentations = randi([0, 4]);  % Number of augmented samples to generate per original sample
...
%% Set the neural network architecture and hyperparameters 
