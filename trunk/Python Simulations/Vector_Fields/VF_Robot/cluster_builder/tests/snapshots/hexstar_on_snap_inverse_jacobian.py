"""Analytical inverse Jacobian for hexstar_on_snap (6 robots).
Maps q_dot (18 state vars) to r_dot (18 robot coords).
State var order: ['x_h', 'y_h', 'theta_c', 'r_1', 'r_2', 'r_3', 'r_4', 'r_5', 'gamma_2', 'gamma_3', 'gamma_4', 'gamma_5', 'phi_1', 'phi_2', 'phi_3', 'phi_4', 'phi_5', 'phi_6']
Robot row order: [x1,y1,...,x6,y6, theta_1,...,theta_6]
"""
import math
import numpy as np

STATE_VARS = ['x_h', 'y_h', 'theta_c', 'r_1', 'r_2', 'r_3', 'r_4', 'r_5', 'gamma_2', 'gamma_3', 'gamma_4', 'gamma_5', 'phi_1', 'phi_2', 'phi_3', 'phi_4', 'phi_5', 'phi_6']
...
def inverse_jacobian(state):
    ...
    J[12, _col["phi_1"]] = 1.0
    J[12, _col["theta_c"]] += 1.0
    J[13, _col["phi_2"]] = 1.0
    J[13, _col["theta_c"]] += 1.0
    J[14, _col["phi_3"]] = 1.0
    J[14, _col["theta_c"]] += 1.0
    J[15, _col["phi_4"]] = 1.0
    J[15, _col["theta_c"]] += 1.0
    J[16, _col["phi_5"]] = 1.0
    J[16, _col["theta_c"]] += 1.0
    J[17, _col["phi_6"]] = 1.0
    J[17, _col["theta_c"]] += 1.0
    return J