"""
Sinking vortex vector fields.

All three variants (sinking_vortex1, sinking_vortex2, sinking_vortex3) have
a nominal center at (0, 0). When loaded with
config/fields/sinking_vortex.yaml (eps > 0), the center wobbles:
...
def sinking_vortex1(x, y, t=0.0, config=None):
    """
...
def sinking_vortex2(x, y, t=0.0, config=None):
    """
    Sinking vortex field - normalized version. All vectors have equal magnitude.
    """
    center_x, center_y = _wobble_center(t, config)
...
def sinking_vortex3(x, y, t=0.0, config=None):
    """
    Sinking vortex field. Combines rotational vortex with radial sink component.
    """
    center_x, center_y = _wobble_center(t, config)
...
sinking_vortex1.config_name = "sinking_vortex"
sinking_vortex2.config_name = "sinking_vortex"
sinking_vortex3.config_name = "sinking_vortex"
