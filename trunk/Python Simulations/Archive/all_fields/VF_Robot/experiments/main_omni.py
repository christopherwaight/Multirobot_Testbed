...
# --- Simulation Mode ---
SIMULATION_MODE = "multi_env"  # Options: "single", "compare", "multi_env"
...
# For 4 robots:
CONTROL_PRIMITIVE_4 = "dual_jacobian_center_finder_advanced"
...
def run_single_simulation():
    ...
    # Run simulation with center estimation tracking enabled
    title = f'{FIELD_MODE.upper()} - {env_name} - {CONTROL_PRIMITIVE}'
    execute_omni_simulation(cluster, control_func, title, track_estimated_center=True)
...
def run_multi_environment_simulation():
    ...
    plt.tight_layout(pad=2.5, h_pad=5.5, w_pad=7.0)
