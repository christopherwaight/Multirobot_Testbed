...
Tests each primitive on multiple field types with 100 random starting positions,
...
# Environments to test (6 fields ending in 1)
ENVIRONMENTS = {
    'sink1': sink1,
    'source1': source1,
    'vortex1': vortex1,
...
PRIMITIVES = {
    ...
    'dual_jacobian_center_finder_advanced': {
        'num_robots': 4,
...
def run_monte_carlo_analysis():
    ...
    for env_name, env_func in ENVIRONMENTS.items():
        ...
        for prim_name, prim_config in PRIMITIVES.items():
            ...
            if len(final_positions) == 0:
                ...
                # Radial standard deviation (combined metric)
                ...
                print(f"  Standard deviation: σx={std_x:.6f}, σy={std_y:.6f}, σr={radial_std:.6f}")
                print(f"  RMSE from true center: {rmse:.6f}")
    ...
    with open(output_file, 'w') as f:
        ...
        f.write("Environment,Primitive,NumRobots,SuccessfulTrials,FailedTrials,SuccessRate,"
               f"AvgX,AvgY,StdX,StdY,RadialStd,RMSE\n")
